...
if (isDateInRange($start, $end)) {
   echo "El estudiante puede matricularse hoy, ya que el periodo de matrícula está activo.";
} else {
   echo "El estudiante no puede matricularse hoy. El periodo de matrícula es del " . $start . " al " . $end . ".";
}